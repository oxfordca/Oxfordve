...
class tsc_PurchaseOrder(models.Model):
    ...
    def tsc_check_values(self, vals):
        ...
        if 'picking_type_id' in vals:
            ...
            if (not tsc_user_in_internal_group and tsc_picking_type_id.tsc_picking_internal_use) or (tsc_user_in_internal_group and not tsc_picking_type_id.tsc_picking_internal_use):
                self.tsc_raise_error()
                
            if (not tsc_user_in_merchandise_group and tsc_picking_type_id.tsc_picking_merchandise_use) or (tsc_user_in_merchandise_group and not tsc_picking_type_id.tsc_picking_merchandise_use):
                self.tsc_raise_error()
